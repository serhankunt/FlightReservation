...
//Aþaðýdaki kod bloðunda dil desteði eklemeye çalýþýyoruz.
#region DI


var builder = WebApplication.CreateBuilder(args);

builder.Services.AddScoped<UserRepository>();//Her requestte dependency injection ile istendiðinde instance türet.
